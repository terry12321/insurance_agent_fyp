export default function Forum() {
    const forumArr = [
        ...
        { title: "Title 4", description: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. " },
            ...
            {forumArr.map((value, index) => {
                return (
                    <div className="bg-cyan-600 rounded-lg flex flex-col gap-4" key={index}>
                        <div className="text-xl py-2 text-center">{value.title}</div>
